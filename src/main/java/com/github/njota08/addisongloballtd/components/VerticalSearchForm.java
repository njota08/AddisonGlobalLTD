/* ****************************************************************************/
package com.github.njota08.addisongloballtd.components;
/* ****************************************************************************/
...
public class VerticalSearchForm implements SearchForm {
    ...
    public VerticalSearchForm(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public void selectNumberOfAdults() {
        WebElement adultsGroup = Utils.waitFor(driver, ExpectedConditions.presenceOfNestedElementLocatedBy(SEARCH_SECTION, ADULTS_GROUP_DROPDOWN));
    ...
    public void selectNumberAndAgeOfChildren() {
        WebElement childrenGroup = Utils.waitFor(driver, ExpectedConditions.presenceOfNestedElementLocatedBy(SEARCH_SECTION, CHILDREN_GROUP_DROPDOWN));
        Select selectChildren = new Select(childrenGroup);
        selectChildren.selectByVisibleText("1 child");
